...
validateMovePC('areaX2',LastCol,LastRow,Ncol,Nrow,Board) :- if_then_else((LastCol==2,LastRow==5),
  ...
  validateMovePC('areaY1',LastCol,LastRow,Ncol,Nrow,Board) :- if_then_else(((LastCol==7,LastRow==5);(LastCol==8,LastRow==5);(trace,LastCol==6,LastRow==5)),
                                                                (Ncol is LastCol-2,
                                                                Nrow is LastRow),
                                                                ((Ncol is LastCol-2,
                                                                Nrow is LastRow+2,
  ...
  validateMovePC('areaY2',LastCol,LastRow,Ncol,Nrow,Board) :-  write('AQUI: '),write(LastCol),write(LastRow),
                                                              if_then_else(((LastCol==5,LastRow==8);(LastCol==5,LastRow==7);(LastCol==5,LastRow==6)),
                                                                ...
                                                                if_then_else((LastCol==6,LastRow==5),
                                                                      ...
                                                                      validateMove('areaX2',LastCol,LastRow,Ncol,Nrow,Board) :- if_then_else((LastCol==2,LastRow==5),
                                                                        ...
                                                                        validateMove('areaY1',LastCol,LastRow,Ncol,Nrow,Board) :- if_then_else(((LastCol==7,LastRow==5);(LastCol==8,LastRow==5);(trace,LastCol==6,LastRow==5)),
                                                                                                                                      (Ncol == LastCol-2,
                                                                                                                                      Nrow == LastRow),
                                                                                                                                      ((Ncol == LastCol-2,
                                                                                                                                      Nrow == LastRow+2,
                                                                        ...
                                                                        validateMove('areaY2',LastCol,LastRow,Ncol,Nrow,Board) :-  write('AQUI: '),write(LastCol),write(LastRow),
                                                                                                                                    if_then_else(((LastCol==5,LastRow==8);(LastCol==5,LastRow==7);(LastCol==5,LastRow==6)),
                                                                                                                                      (Ncol == LastCol,
                                                                                                                                      Nrow == LastRow-2),
                                                                                                                                      ((Ncol == LastCol-2,
